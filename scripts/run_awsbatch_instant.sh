...
BUCKET_DIR="${NXF_AWS_WORKDIR:-s3://multiomic-project-data/nxf-work}"
OUTDIR="${NXF_AWS_OUTDIR:-s3://multiomic-project-data/data/PRJNA647806/results}"
INPUT="s3://multiomic-project-data/data/PRJNA647806/sample_sheet.csv"
